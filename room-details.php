...
<td colspan="2"><a href="javascript:void(0);"  onClick="popUpWindow('http://localhost/hostel/full-profile.php?id=<?php echo $row->emailid;?>');" title="View Full Details">Print Data</a></td>
</tr>
<tr>
<td><b>Room no :</b></td>
...
<tr>
<td><b>Full Name :</b></td>
<td colspan="2"><?php echo $row->firstName;?><?php echo $row->middleName;?><?php echo $row->lastName;?></td>
<td><b>Email :</b></td>
...
<td colspan="2"><?php echo $row->egycontactno;?></td>
<td><b>Guardian Name :</b></td>
<td colspan="2"><?php echo $row->guardianName;?></td>
</tr>

<tr>
<td><b>Guardian Relation :</b></td>
<td colspan="2"><?php echo $row->guardianRelation;?></td>
